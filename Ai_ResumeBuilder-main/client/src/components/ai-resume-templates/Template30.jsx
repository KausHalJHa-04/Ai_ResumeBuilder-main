        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: "20px",  }}>
            {editMode ? (
              ...
              <>
                <h1 style={{ fontSize: "38px", fontWeight: "900", color: "#0ff" }}>
                  {resumeData.name}
                </h1>
          ...
          {/* Summary */}
          <div>
            <h2 style={{ ...sectionTitle, color: "#2346dd", fontSize: "1.5rem", fontWeight: "bold" }}>Summary</h2>
            {editMode ? (
              <textarea
          ...
          {/* Projects */}
          <div>
            <h2 style={{ ...sectionTitle, color: "#2346dd", fontSize: "1.5rem", fontWeight: "bold" }}>Projects</h2>
          ...
          {/* Certifications */}
          <div>
            <h2 style={{ ...sectionTitle, color: "#2346dd", fontSize: "1.5rem", fontWeight: "bold" }}>Certifications</h2>
            <ul>
          ...
          {/* Achievements */}
          <div>
            <h2 style={{ ...sectionTitle, color: "#2346dd", fontSize: "1.5rem", fontWeight: "bold" }}>Achievements</h2>
            <ul>
